        ...
        child: SingleChildScrollView(
              child:   Column(
                      ...
                      const   SizedBox(
                         ...
                         Text("My Dashboard", style: Theme.of(context).textTheme.headline4?.copyWith(fontWeight: FontWeight.w600),),
                         SizedBox(
                           height: 15,
                         ),
                         Container(
...
class TopSginin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(  left: 30, right: 20, bottom: 22),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
